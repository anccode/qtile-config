...
color_border_activo="#46D120",
color_bar_active="#46D120",
...
keys = [
    ...
    Key([alt], "space",  lazy.run_extension(extension.DmenuRun(
    ...
    #captura de pantalla
    Key([mod], "F12", lazy.spawn("scrot -s /home/angel/Pictures/recortes/recorte.jpg")),
    Key([], "F12", lazy.spawn("scrot /home/angel/Pictures/capturas/captura.jpg")),
    Key(["shift"], "F12", lazy.spawn("redshift -O 5000")),
    Key(["shift"],"F11", lazy.spawn("redshift -x")),
...
__groups={
        ...
        1: Group("  "),
        2: Group("  "),
        3: Group("  ", matches=[Match(wm_class=["google-chrome-stable","microsoft-edge"])]),
        4: Group("  "),
        5: Group("   "),
        0: Group("  "),        
        }
    ...
    Screen(
        top=bar.Bar(
            [
                ...
                widget.GroupBox(
                    highlight_color=["#46D120"], #color del borde de la bara verde
                    highlight_method="line",
                    spacing=0,
                    inactive="f1f1f1", #color de la barra inactiva
                    active="#f1f1f1",
